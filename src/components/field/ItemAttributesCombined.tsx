...
type TItemAttributesCombinedProps = {};

const ItemAttributesCombined = ({}: TItemAttributesCombinedProps) => {
  const uid = useId();
...
const ItemAttributesCombinedStyled = styled.div`
  .wrapper {
    --f-columns: 2;
    --f-gap: 24px;
    display: flex;
...
export default ItemAttributesCombined;
