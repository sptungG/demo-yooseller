...
type TExperienceFormListProps = {
  name?: string | number | (string | number)[];
};

function ExperienceFormList({ name = ["properties", "experience"] }: TExperienceFormListProps) {
                ...
                title: (
                  <PropertiesFormListItemStyled>
                    ...
                    <Form.Item name={[field.name, "name"]} noStyle rules={[{ required: true }]}>
                      <Input
                        placeholder={`${i18n["Tên Nơi làm việc"]} ${index + 1}`}
                        variant="borderless"
                      />
                    </Form.Item>
                    <Form.Item name={[field.name, "position"]} noStyle rules={[{ required: true }]}>
                      <Input placeholder={i18n["Vị trí phụ trách"]} variant="borderless" />
                    </Form.Item>
                    <Form.Item
              ...
              })),
              {
                ...
                title: (
                  <Button
                    ...
                    icon={<BsPlusLg />}
                  >
                    {i18n["Thêm kinh nghiệm làm việc"]}
                  </Button>
                ),
              },
            ]}
