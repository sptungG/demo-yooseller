...
import { useCustomersFarmColumns } from "src/components/table/useCustomersColumns";
...
const Page = () => {
  ...
  const Columns = useCustomersFarmColumns();
            ...
            extra={
              <>
                ...
                <Button
                  type="primary"
                  icon={<BsPlusLg />}
                  href={`/supplier/farm/${farmId}/customers/create`}
                >
