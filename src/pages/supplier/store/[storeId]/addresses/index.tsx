...
import useProviceAddressesColumns from "src/components/table/useProviceAddressesColumns";
...
const Page = () => {
  ...
  const Columns = useProviceAddressesColumns();
  const mappedColumns = useCreation(() => {
    ...
    return [
      ...
      { ...addressDetail, ellipsis: true, width: 300 },
            ...
            extra={
              <>
                ...
                <Button
                  type="primary"
                  icon={<BsPlusLg />}
                  href={`/supplier/store/${storeId}/addresses/create`}
                >
                  {i18n["Thêm địa chỉ"]}
                </Button>
              </>
